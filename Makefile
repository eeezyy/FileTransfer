...
${PROGRAM_SERVER}: ${PROGRAM_SERVER}.o
	gcc ${CFLAGS} -o ${PROGRAM_SERVER} ${PROGRAM_SERVER}.o -lldap -DLDAP_DEPRECATED

${PROGRAM_SERVER}.o: ${PROGRAM_SERVER}.c
	gcc ${CFLAGS} -c ${PROGRAM_SERVER}.c -lldap -DLDAP_DEPRECATED
	
${PROGRAM_CLIENT}: ${PROGRAM_CLIENT}.o
	gcc ${CFLAGS} -o ${PROGRAM_CLIENT} ${PROGRAM_CLIENT}.o -lcurses

${PROGRAM_CLIENT}.o: ${PROGRAM_CLIENT}.c
	gcc ${CFLAGS} -c ${PROGRAM_CLIENT}.c -lcurses
